...
var EdgeDocument = (function () {
   ...
   * Add outV
   *
   * @param {VertexDocument|Number} outV
   ...
   * Add inV
   *
   * @param {VertexDocument|Number} inV
   ...
   * @api public
   */
  EdgeDocument.prototype.save = function (get, options) {
    var self = this;    
   ...
   * @api public
   */
  EdgeDocument.prototype.get = function (options) {
    var self = this;    
