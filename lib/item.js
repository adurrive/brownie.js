...
var Item = (function () {
   ...
   * @api private
   */
  function Item (schema, doc, enablecripts, fromTitan) {
    var property;
    ...
    if (doc.hasOwnProperty('properties')) {
      this.addProperties(doc, enablecripts, fromTitan);
    }
  }
   ...
   * @api public
   */
  Item.prototype.addProperty = function (name, value, enablecripts, fromTitan) {
   ...
   * @api public
   */
  Item.prototype.addProperties = function (doc, enablecripts, fromTitan) {
    var property;
